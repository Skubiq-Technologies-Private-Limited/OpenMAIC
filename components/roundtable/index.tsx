...
export function Roundtable({
  ...
  return (
    <div
      className={cn(
        'h-[128px] w-full flex flex-col relative z-10 transition-all duration-300',
    ...
    >
      ...
      {/* ── Full-width AI teacher speech area ── */}
      <div
        className={cn(
          'flex-1 flex items-stretch min-h-0 px-4 pb-3 transition-opacity duration-300',
          isPresenting && !controlsVisible && 'opacity-0 pointer-events-none',
        )}
      >
            ...
            {bubbleRole && (
              ...
              >
                <div
                  ...
                  className={cn(
                    'relative w-full px-4 pt-2 pb-3 rounded-xl text-[15px] leading-relaxed transition-all border group/bubble flex flex-col max-h-[72px] cursor-pointer',
                    bubbleRole === 'user'
                      ? 'bg-purple-600/95 dark:bg-purple-500/95 backdrop-blur-sm border-purple-400/40 dark:border-purple-300/40 text-white shadow-md shadow-purple-300/30 dark:shadow-purple-800/30'
                      : bubbleRole === 'agent'
                        ? cn(
                            'bg-blue-50/95 dark:bg-blue-950/60 backdrop-blur-sm border-blue-200/60 dark:border-blue-800/60 text-gray-700 dark:text-gray-200 shadow-sm',
                            (isInLiveFlow || isTopicPending) && 'hover:shadow-md',
                          )
                        : 'bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700 text-gray-700 dark:text-gray-200 shadow-sm hover:shadow-md',
                  )}
                >
                  ...
                  {bubbleRole !== 'user' &&
                    ...
                    (() => {
                      ...
                      if (btnState === 'play') {
                        return (
                          <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-purple-100 dark:hover:bg-purple-900/50 group-hover/bubble:bg-purple-100 dark:group-hover/bubble:bg-purple-900/50 transition-all duration-300">
